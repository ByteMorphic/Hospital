...
Route::middleware(['auth', 'verified'])->group(function () {
    // For Ward Routes
    Route::put('/wards/update-status', [WardController::class, 'updateStatus'])->name('wards.status');
    Route::resource('wards', WardController::class);

    // Generics Routes
    Route::put('/generics/update-status', [GenericController::class, 'status'])->name('generics.status');
    Route::resource('generics', GenericController::class)->except('update');
