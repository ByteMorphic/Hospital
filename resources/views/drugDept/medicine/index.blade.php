...
<div class="container p-6 mx-auto lg:p-24">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col" class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase">Sr No.</th>
                        <th scope="col" class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase">Medicine Name</th>
                        <th scope="col" class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase">Generic Name</th>
                    ...
                    @forelse($medicines as $medicine)
                        <tr class="transition hover:bg-gray-50" data-medicine-id="{{ $medicine->id }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 py-1 text-sm {{ $medicine->status ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }} rounded-full">
    ...
    <!-- Add Stock Modal -->
    <div id="addStockModal" class="fixed inset-0 z-50 hidden overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
