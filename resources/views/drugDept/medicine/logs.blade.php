...
<div class="container mx-auto p-6 dark:bg-gray-800 dark:text-white">
    <div class="header mb-6 text-center">
        ...
        <a href="{{ route('medicines.index') }}" class="inline-block mt-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-sm transition duration-200">
            Back
        </a>
    </div>
