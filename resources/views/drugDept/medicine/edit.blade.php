    ...
    <div class="mx-auto w-full max-w-[550px] p-3 shadow-lg rounded-md bg-white dark:bg-gray-800">
        <form class="space-y-6" action="{{ route('medicines.update', $medicine->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="name" name="name" type="text" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-hidden focus:border-[#6A64F1] focus:shadow-md placeholder:opacity-70 placeholder-gray-300" value="{{ $medicine->name }}">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="description" name="description" type="text" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-hidden focus:border-[#6A64F1] focus:shadow-md placeholder:opacity-70 placeholder-gray-300" value="{{ $medicine->description }}" placeholder="Any Description (optional)">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="quantity" name="quantity" type="number" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-hidden focus:border-[#6A64F1] focus:shadow-md placeholder:opacity-70 placeholder-gray-300" value="{{ $medicine->quantity }}" readonly>
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="price" name="price" type="number" placeholder="Leave Empty, if its free" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-hidden focus:border-[#6A64F1] focus:shadow-md placeholder:opacity-70 placeholder-gray-300" value="{{ $medicine->price }}">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="batch_no" name="batch_no" type="text" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-hidden focus:border-[#6A64F1] focus:shadow-md placeholder:opacity-70 placeholder-gray-300" value="{{ $medicine->batch_no }}">
...
{{-- 
            <div>
                ...
                <div class="mt-2">
                    <input id="dosage" name="dosage" type="text" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-hidden focus:border-[#6A64F1] focus:shadow-md placeholder:opacity-70 placeholder-gray-300" value="{{ $medicine->dosage }}">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="strength" name="strength" type="text" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-hidden focus:border-[#6A64F1] focus:shadow-md placeholder:opacity-70 placeholder-gray-300" value="{{ $medicine->strength }}">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="notes" name="notes" type="text" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-hidden focus:border-[#6A64F1] focus:shadow-md placeholder:opacity-70 placeholder-gray-300" value="{{ $medicine->notes }}">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="expiry_date" name="expiry_date" type="date" required class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-hidden focus:border-[#6A64F1] focus:shadow-md placeholder:opacity-70 placeholder-gray-300" value="{{ old('expiry_date', \Carbon\Carbon::parse($medicine->expiry_date)->format('Y-m-d')) }}">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="category" name="category" type="text" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-hidden focus:border-[#6A64F1] focus:shadow-md placeholder:opacity-70 placeholder-gray-300" value="{{ $medicine->category }}">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="manufacturer" name="manufacturer" type="text" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-hidden focus:border-[#6A64F1] focus:shadow-md placeholder:opacity-70 placeholder-gray-300" value="{{ $medicine->manufacturer }}">
            ...
            <div class="flex items-center justify-between">
                ...
                <input id="status" name="status" type="checkbox" class="rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-hidden focus:border-[#6A64F1] focus:shadow-md" value="1" {{ old('status', $medicine->status ?? false) ? 'checked' : '' }}>
            ...
            <div>
                ...
                <div class="mt-2">
                    <input type="file" name="image" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-hidden focus:border-[#6A64F1] focus:shadow-md placeholder:opacity-70 placeholder-gray-300">
            ...
            <div>
                <button type="submit" class="flex w-full justify-center rounded-md bg-indigo-600 hover:bg-indigo-500 text-white px-3 py-1.5 text-sm font-semibold leading-6 shadow-xs focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Submit</button>
            </div>
        </form>
    </div>
@endsection
