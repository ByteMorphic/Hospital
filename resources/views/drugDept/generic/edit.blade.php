    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="{{ route('generics.update', $generic->id) }}" method="POST">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="generic_name" name="generic_name" type="text" class="block w-full rounded-md border-0 py-1.5 pl-2 text-gray-900 shadow-xs ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="{{ old('generic_name', $generic->generic_name) }}">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="therapeutic_class" name="therapeutic_class" type="text" class="block w-full rounded-md border-0 py-1.5 pl-2 text-gray-900 shadow-xs ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="{{ old('therapeutic_class', $generic->therapeutic_class) }}">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="generic_notes" name="generic_notes" type="text" class="block w-full rounded-md border-0 py-1.5 pl-2 text-gray-900 shadow-xs ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="{{ old('generic_notes', $generic->generic_notes) }}">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="generic_status" name="generic_status" type="checkbox" class="block rounded-md border-0 py-1.5 text-gray-900 shadow-xs ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" {{ old('generic_status', $generic->generic_status) ? 'checked' : '' }}>
